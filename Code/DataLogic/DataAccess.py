...
class AccessData(object):
    ...
    def readColdSales(self):
        self.items = self.dl.execute('SELECT Name, Sales, Stock FROM Items WHERE Type = "Cold" ')
        return self.items
    
    def readHardSales(self):
        self.items = self.dl.execute('SELECT Name, Sales, Stock FROM Items WHERE Type = "Hard" ')
        return self.items
